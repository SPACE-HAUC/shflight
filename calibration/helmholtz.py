...
class lsm9ds1:
    ...
    def readMag(self):
        bx = self.sbus.read_word_data(self.mag_addr, 0x40) / 6.842
        by = self.sbus.read_word_data(self.mag_addr, 0x42) / 6.842
        bz = self.sbus.read_word_data(self.mag_addr, 0x44) / 6.842
        return (bx, by, bz)
